...
let selectedItem = {
        ...
        if (text=="Đặt hàng"){
            ...
            if ((name == "" || email =="" || phone =="" || address=="" || !checkRadio)){
                ...
                if (confirm("Bạn muốn đặt đơn hàng này ?")) {
                    ...
                    btn.href = "http://localhost/web222/home/success/"+orderID+"/" +userID+"/" +datetime+"/" +totalPrice+"/" +name+"/"+email+"/" +phone+"/"+address;
    ...
    function ChangeUI(){
        ...
        if (productNumber > 0){
            ...
            // btn.href = 'http://localhost/web222/Home/payment/';
            ...
            var btn = document.getElementById('page-cart__control-btn');
            btn.href = 'http://localhost/web222/Home/catalog';
