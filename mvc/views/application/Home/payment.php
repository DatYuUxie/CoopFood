            ...
            <div class="first-screen__box page-info">
                ...
                <div class="first-screen__breadcrumb">
                    <ul class="uk-breadcrumb">
                        ...
                        <li> <a href="http://localhost/web222/home/cart">Giỏ hàng</a></li>
...
<script>
    ...
    function getOrder(){
      ...
      btn.href = 'http://localhost/web222/Home/success/'+orderID+"/" +userID+"/" +datetime+"/" +price+"/" +name+"/"+email+"/" +phone+"/"+address;
    ...
    paypal.Buttons({
        ...
        onApprove: function (data, actions){
            return actions.order.capture().then(function(orderData){
                ...
                window.location.href = 'http://localhost/web222/Home/success/'+orderID+"/" +userID+"/" +datetime+"/" +price+"/" +name+"/"+email+"/" +phone+"/"+address;
            });
        },
