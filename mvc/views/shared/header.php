        ...
        <div class="uk-container">
            <div class="uk-navbar-container bg-green" data-uk-navbar="">
                <div class="uk-navbar-left">
                    <a href="http://localhost/web222/home/index">
                ...
                <div class="uk-navbar-center">
                    <ul class="uk-navbar-nav">
                        <li><a href="http://localhost/web222/home/index"><span class="nav-btn home">Trang chủ</span></a></li>
                        <li><a href="http://localhost/web222/home/catalog"><span class="nav-btn catalog">Sản Phẩm</span></a>
                        </li>
                        <li><a href="http://localhost/web222/news/index"><span class="nav-btn news">Tin tức</span></a></li>
                        <li><a href="http://localhost/web222/home/contact"><span class="nav-btn contact">Liên hệ</span></a></li>
                    </ul>
                </div>
                        ...
                        <ul class="other-links-list">
                            <li>
                                <?php
                                  ...
                                  else echo "<a style='color: white; font-size: 16px; text-decoration: none; ' href='http://localhost/web222/User/sign_in' class='nav-btn'>Đăng nhập</a>";
                            ...
                            <li><a href="http://localhost/web222/home/cart">
                                    <span class="text-white" data-uk-icon="cart">
                                    </span></a></li>

                            <?php
                              if (isset($_SESSION['id'])){
                                echo "<li><a href='http://localhost/web222/home/account'><span class='text-white' data-uk-icon='user'></span></a></li>
                                  <li><a href='http://localhost/web222/User/log_out'><span class='text-white' data-uk-icon='sign-out'></span></a></li>";
                              }
                            ?>
                        </ul>
                    </div>
                    ...
                    <div class="other-links">
                        <ul class="other-links-list">
                            <li>
                                ...
                                echo "<a style='color: white; font-weight: bold' href='http://localhost/web222/User/sign_in' class='nav-btn'>Đăng nhập</a>";
                                ?>
                            </li>
        ...
        <div class="uk-offcanvas-bar">
            ...
            <div class="uk-margin-top">
                <ul class="uk-nav">
                    ...
                    <li><a href="http://localhost/web222/home/catalog">Sản phẩm</a></li>
                    <li><a href="http://localhost/web222/News/index">Tin tức</a></li>
                    <li><a href="http://localhost/web222/home/contact">Liên hệ</a></li>
                </ul>
            </div>
            <hr class="uk-margin">
            <ul class="uk-nav uk-nav-parent-icon" data-uk-nav>
                <li class="">
                    <a href="http://localhost/web222/home/catalog">Thực phẩm</a>
                </li>

                <li class="">
                    <a href="http://localhost/web222/home/catalog">Nước ngọt</a>
                </li>

                <li class="">
                    <a href="http://localhost/web222/home/catalog">Bánh kẹo</a>
                </li>

                <li class="">
                    <a href="http://localhost/web222/home/catalog">Trái cây</a>
                </li>
            </ul>
            <hr class="uk-margin">
            <div class="uk-margin-bottom">
...
<?php 
    if(isset($_POST['searchinput']))
    {
      echo '<script type = "text/javascript">
        window.location.href = "http://localhost/web222/home/search/' . $_POST['searchinput'] . '"</script>';
    }
  ?>